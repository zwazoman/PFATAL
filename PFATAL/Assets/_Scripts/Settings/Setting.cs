...
public class Setting : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*
         * _textMoveUp.text = _values.
         * _textMoveDown.text = _values.
         * _textMoveLeft.text = _values.
         * _textMoveRight.text = _values.
         * _textJump.text = _values.
         * _textInteract.text = _values.
         * _textDrop.text = _values.
        */
